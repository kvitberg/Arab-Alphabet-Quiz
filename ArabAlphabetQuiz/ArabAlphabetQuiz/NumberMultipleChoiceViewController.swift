//
//  NumberMultipleChoiceViewController.swift
//  ArabAlphabetQuiz
//
...
class NumberMultipleChoiceViewController: UIViewController {
    ...
    @IBAction func cardButtonHandler(sender: UIButton) {
        ...
        if questionIdx < arabNumbersArray!.count - 1 {
            questionIdx += 1
        }else{
            questionIdx = 0
        }
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(NumberMultipleChoiceViewController.appBecameActive), name: UIApplicationDidBecomeActiveNotification, object: nil)
        
        
        arabNumbersArray!.shuffle()
        nextQuestion()
    ...
    func nextQuestion(){
        ...
        let currentQuestion = arabNumbersArray![questionIdx]
    ...
    func startTimer(){
        ...
        timer = NSTimer.scheduledTimerWithTimeInterval(0.01, target:self, selector: #selector(NumberMultipleChoiceViewController.updateProgressView), userInfo: nil, repeats: true)
