//
//  AlphabethMultipleChoiceViewController.swift
//  ArabAlphabetQuiz
//
//  Created by Scott Kvitberg on 26/08/16.
...
class AlphabethMultipleChoiceViewController: UIViewController {
    ...
    @IBAction func AnswerButtonHandler(sender: UIButton) {
        ...
        if sender.titleLabel!.text == correctAnswer{
            self.cardButton.setTitle("التالى", forState: .Normal)
            print("answerbutton")
            print("Correct")
            currentScore += 1
    ...
    @IBAction func cardButtonHandler(sender: UIButton) {
        ...
        if questionIdx < arabAlphabethArray!.count - 1 {
            questionIdx += 1
        }else{
            questionIdx = 0
        }
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(AlphabethMultipleChoiceViewController.appBecameActive), name: UIApplicationDidBecomeActiveNotification, object: nil)
        
        
        arabAlphabethArray!.shuffle()
        nextQuestion()
    ...
    func nextQuestion(){
        ...
        let currentQuestion = arabAlphabethArray![questionIdx]
    ...
    func startTimer(){
        ...
        timer = NSTimer.scheduledTimerWithTimeInterval(0.01, target:self, selector: #selector(AlphabethMultipleChoiceViewController.updateProgressView), userInfo: nil, repeats: true)
